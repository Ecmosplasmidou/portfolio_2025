...
export const translations = {
  fr: {
    ...
    heroDescription: "J'ai conçu et développé diverses applications full-stack, allant de solutions web interactives à des boutiques e-commerce performantes.",
